...
git clone https://github.com/cfjdoedens/auditstratified.git
cd auditstratified
...
Na de uitvoering van de controle kun je de gevonden fouten (k_laag of bedragen in het hoogstratum) evalueren.
